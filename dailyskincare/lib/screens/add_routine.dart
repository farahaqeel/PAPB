                    ...
                    child: TextFormField(
                      decoration: InputDecoration(
                        ...
                        labelStyle: const TextStyle(
                          color:  Color.fromARGB(255, 195, 3, 229), // Label color
                        ),
                        focusedBorder: OutlineInputBorder(
                          borderSide: const BorderSide(
                            color:  Color.fromARGB(255, 195, 3, 229), // Border color when focused
                        ...
                        enabledBorder: OutlineInputBorder(
                          borderSide: const BorderSide(
                            color:  Color.fromARGB(255, 195, 3, 229), // Border color when not focused
                  ...
                  Container(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      hint: const Text(
                        'Pilih Periode',
                        style: TextStyle(
                          color:  Color.fromARGB(255, 195, 3, 229), // Hint text color
                        ),
                      ),
                        ...
                        return DropdownMenuItem<String>(
                          ...
                          child: Text(
                            ...
                            style: const TextStyle(
                              color:  Color.fromARGB(255, 195, 3, 229), // Dropdown option text color
                            ),
                          ),
                        );
                      }).toList(),
                      ...
                      decoration: const InputDecoration(
                        ...
                        labelStyle: TextStyle(
                          color:  Color.fromARGB(255, 195, 3, 229), // Label text color
                        ),
                      ...
                      child: LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          return SelectWeekDays(
                            ...
                            selectedDayTextColor: const Color.fromARGB(255, 195, 3, 229),
                            unSelectedDayTextColor: const Color.fromARGB(255, 195, 3, 229),
                          );
                        },
                      ),
                    ),
